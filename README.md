...
## 🗂️ Метрики
Создан параметризованный дашборд на основе стандартных метрик
RED-метрики
...
## RED
![{DCA4F20A-C0A4-43D0-8D87-96109623274E}](https://github.com/user-attachments/assets/f8389e0c-42f9-4608-b9ec-a67f3a65b8b0)
