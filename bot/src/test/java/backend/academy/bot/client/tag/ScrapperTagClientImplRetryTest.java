...
public class ScrapperTagClientImplRetryTest {
    ...
    void getListLinksByTag_shouldSuccessWhenServerReturnsError() {
        ...
        assertThrows(WebClientResponseException.class,
            () -> client.getListLinksByTag(123L, new TagLinkRequest("some tag")));
    }
    ...
    void getAllListLinksByTag_shouldSuccessWhenServerReturnsError() {
        WireMockTestUtil.getWireMockServer().stubFor(get(urlPathMatching("/tag/123/all"))
            .willReturn(aResponse()
                .withStatus(HttpStatus.INTERNAL_SERVER_ERROR.value())));

        assertThrows(WebClientResponseException.class,
            () -> client.getAllListLinksByTag(123L));
    }
