...
public class TgChatLinkDaoImpl implements TgChatLinkDao {
    ...
    private static final String GET_LINK_IDS_QUERY = "SELECT link_id FROM tg_chat_links WHERE tg_chat_id = ?";
    private static final String ADD_RECORD_QUERY = "INSERT INTO tg_chat_links (tg_chat_id, link_id) VALUES (?, ?)";
